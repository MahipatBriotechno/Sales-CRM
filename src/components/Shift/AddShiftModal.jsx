...
import { useAddShiftMutation } from "../../store/api/shiftApi";
import { toast } from "react-hot-toast";

export default function AddShiftModal({ onClose }) {
  ...
  const [formData, setFormData] = useState({
    ...
    check_out_time: "",
    working_hours: "",
    attendance_method: "WiFi Check-in",
    grace_period: 15,
    late_marking: false,
    half_day_enable: false,
    min_work_hours_half_day: "",
    half_day_cutoff_time: "",
    overtime_enable: false,
    min_overtime_after: "",
    overtime_rate: "",
  ...
  // Auto-calculate working hours based on check-in and check-out
  useEffect(() => {
          ...
          <form id="add-shift-form" onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select
                            ...
                            className={`w-full p-2 border rounded-sm focus:outline-none focus:ring-1 focus:ring-[#FF7B1D] focus:border-[#FF7B1D] ${
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            className="w-full p-2 border border-gray-300 rounded-sm focus:outline-none focus:ring-1 focus:ring-[#FF7B1D] focus:border-[#FF7B1D]"
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            readOnly
                            className="w-full p-2 border border-gray-200 bg-gray-100 rounded-sm focus:outline-none"
            ...
            <div className="bg-white p-5 rounded-sm border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="flex items-center mt-6">
                        ...
                        />
                        <label htmlFor="late_marking" className="ml-2 block text-sm text-gray-700">
            ...
            <div className="bg-white p-5 rounded-sm border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center gap-2 mb-4 border-b border-gray-100 pb-2">
                    ...
                    <div className="flex items-center ml-auto">
                        <input
                            ...
                            className="w-4 h-4 text-[#FF7B1D] border-gray-300 rounded focus:ring-[#FF7B1D]"
                        />
                        <label htmlFor="half_day_enable" className="ml-2 block text-sm font-bold text-gray-700">
                            Enable Half Day
                        </label>
                    </div>
                </div>
                ...
                {formData.half_day_enable && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Minimum Work Hours for Half Day <span className="text-red-500">*</span></label>
                            <input
                                type="number"
                                step="0.5"
                                ...
                                onChange={handleChange}
                                className={`w-full p-2 border rounded-sm focus:outline-none focus:ring-1 focus:ring-[#FF7B1D] focus:border-[#FF7B1D] ${
                                    errors.min_work_hours_half_day ? 'border-red-500' : 'border-gray-300'
                                }`}
                                placeholder="e.g. 4"
                            />
                            {errors.min_work_hours_half_day && <p className="text-red-500 text-xs mt-1">{errors.min_work_hours_half_day}</p>}
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Half Day Cut-off Time (Optional)</label>
                            <input
                                type="time"
            ...
            <div className="bg-white p-5 rounded-sm border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center gap-2 mb-4 border-b border-gray-100 pb-2">
                    ...
                    <div className="flex items-center ml-auto">
                        <input
                            ...
                            className="w-4 h-4 text-[#FF7B1D] border-gray-300 rounded focus:ring-[#FF7B1D]"
                        />
                        <label htmlFor="overtime_enable" className="ml-2 block text-sm font-bold text-gray-700">
                            Enable Overtime
                        </label>
                    </div>
                </div>
                ...
                {formData.overtime_enable && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Minimum Overtime After (Minutes) <span className="text-red-500">*</span></label>
                            <input
                                type="number"
                                ...
                                onChange={handleChange}
                                className={`w-full p-2 border rounded-sm focus:outline-none focus:ring-1 focus:ring-[#FF7B1D] focus:border-[#FF7B1D] ${
                                    errors.min_overtime_after ? 'border-red-500' : 'border-gray-300'
                                }`}
                                placeholder="e.g. 30"
                            />
                            {errors.min_overtime_after && <p className="text-red-500 text-xs mt-1">{errors.min_overtime_after}</p>}
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Overtime Rate <span className="text-red-500">*</span></label>
                            <div className="flex items-center border border-gray-300 rounded-sm overflow-hidden focus-within:ring-1 focus-within:ring-[#FF7B1D] focus-within:border-[#FF7B1D]">
                            ...
                            {errors.overtime_rate && <p className="text-red-500 text-xs mt-1">{errors.overtime_rate}</p>}
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Overtime Calculation Base</label>
                            <select
                                name="overtime_calculation"
                                value={formData.overtime_calculation}
                                onChange={handleChange}
                                className="w-full p-2 border border-gray-300 rounded-sm focus:outline-none focus:ring-1 focus:ring-[#FF7B1D] focus:border-[#FF7B1D]"
                            >
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Max Overtime per day (Mins)</label>
                            <input
                                type="number"
