...
export default function WonLeads() {
    ...
    const handleExport = () => {
        ...
        a.href = url;
        a.download = `won_leads_${new Date().toISOString().split("T")[0]}.csv`;
        a.click();
    };
            ...
            <div className="min-h-screen bg-white">
                ...
                <div className="bg-white sticky top-0 z-30">
                    <div className="max-w-8xl mx-auto px-4 py-4 border-b">
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                            <div>
                                <h1 className="text-2xl font-bold text-gray-800">Won Leads</h1>
                ...
                <div className="max-w-8xl mx-auto p-4 pt-0 mt-2">
                    {/* <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-3">
                        <NumberCard title="Total Won" number={totalLeads.toString()} icon={<Users className="text-blue-600" size={24} />} iconBgColor="bg-blue-100" lineBorderClass="border-blue-500" />
                        <NumberCard title="Quick Filters" number="Won" icon={<Server className="text-green-600" size={24} />} iconBgColor="bg-green-100" lineBorderClass="border-green-500" />
                    ...
                    <div className="pb-6">
                        {isLoading ? (
                            ...
                            <div className="text-center text-red-500 py-10 capitalize">Failed to load won leads.</div>
                        ) : leadsData.length === 0 ? (
                            <EmptyState
                                title="No Won Leads Yet"
                                message="You haven't won any leads yet. Keep pushing, success is just around the corner!"
                                type="leads"
                            />
                        ) : (
                            <>
