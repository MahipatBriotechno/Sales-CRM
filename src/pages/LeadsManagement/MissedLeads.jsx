...
export default function MissedLeads() {
    ...
    const handleExport = () => {
        ...
        a.href = url;
        a.download = `missed_leads_${new Date().toISOString().split("T")[0]}.csv`;
        a.click();
    };
            ...
            <div className="min-h-screen bg-white">
                ...
                <div className="max-w-8xl mx-auto p-4 pt-0 mt-2">
                    {/* <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-3">
                        <NumberCard title="Total Missed" number={totalLeads.toString()} icon={<Users className="text-blue-600" size={24} />} iconBgColor="bg-blue-100" lineBorderClass="border-blue-500" />
                        <NumberCard title="Quick Filters" number="Missed" icon={<Server className="text-green-600" size={24} />} iconBgColor="bg-green-100" lineBorderClass="border-green-500" />
