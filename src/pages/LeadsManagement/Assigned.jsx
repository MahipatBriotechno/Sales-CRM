...
export default function AssignedLeads() {
  ...
  const handleExport = () => {
    ...
    a.href = url;
    a.download = `assigned_leads_${new Date().toISOString().split("T")[0]}.csv`;
    a.click();
  };
    ...
    <>
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="max-w-8xl mx-auto p-4 pt-0 mt-2">
          ...
          <div className="pb-6">
            {isLoading ? (
              ...
              <div className="text-center text-red-500 py-10 capitalize">Failed to load assigned leads.</div>
            ) : leadsData.length === 0 ? (
              <EmptyState
                title="No assigned leads"
                message="You don't have any leads assigned to you at the moment."
                type="leads"
              />
            ) : (
              <>
        ...
        <AssignLeadsModal
          ...
          title="Change Lead Assignment"
          buttonText="Update Assignment"
          selectedLeadsList={leadsData.filter(lead => selectedLeads.includes(lead.id))}
        />
