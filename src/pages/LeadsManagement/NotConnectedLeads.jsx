...
export default function NotConnectedLeads() {
    ...
    const handleExport = () => {
        ...
        a.href = url;
        a.download = `not_connected_leads_${new Date().toISOString().split("T")[0]}.csv`;
        a.click();
    };
            ...
            <div className="min-h-screen bg-white">
                ...
                <div className="max-w-8xl mx-auto p-4 pt-0 mt-2">
                    {/* <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-3">
                        <NumberCard title="Total Not Connected" number={totalLeads.toString()} icon={<Users className="text-blue-600" size={24} />} iconBgColor="bg-blue-100" lineBorderClass="border-blue-500" />
                        <NumberCard title="Quick Filters" number="Not Connected" icon={<Server className="text-green-600" size={24} />} iconBgColor="bg-green-100" lineBorderClass="border-green-500" />
                    ...
                    <div className="pb-6">
                        {isLoading ? (
                            ...
                            <div className="text-center text-red-500 py-10 capitalize">Failed to load not connected leads.</div>
                        ) : leadsData.length === 0 ? (
                            <EmptyState
                                title="No Unconnected Leads"
                                message="Great job! All leads have been reached out to."
                                type="leads"
                            />
                        ) : (
                            <>
